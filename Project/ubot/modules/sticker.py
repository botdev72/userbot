...
@KY.UBOT("memes", sudo=True)
async def _(client, message):
    if len(message.command) < 2:
        return await message.reply(f"{emo.gagal} <code>memes</code> [text]")
...
async def kang(client, message):
    ...
    Tm = await message.reply(f"{emo.proses} **Boleh juga ni stickernya colong ahh...**")
    media_ = None
    emoji_ = None
    is_anim = False
    is_video = False
    ...
    if replied and replied.media:
        if replied.photo:
            ...
            if not replied.sticker.file_name:
                await Tm.edit(f"{emo.gagal} **Stiker tidak memiliki Nama!**")
                return
            ...
            await Tm.edit(f"{emo.gagal} **File Tidak Didukung.**")
            return
        media_ = await client.download_media(replied, file_name="ubot/resources/")
    else:
        await Tm.edit(f"{emo.gagal} **Silahkan Reply ke Media Foto/GIF/Sticker!**")
        return
    if media_:
        ...
        while True:
            ...
            if exist.set.count >= limit:
                ...
                await Tm.edit(
                    f"{emo.proses} **Membuat Sticker Pack Baru {pack} Karena Sticker Pack Sudah Penuh.**",
                )
                continue
            break
        if exist is not False:
            ...
            while limit in await get_response(message, client):
                ...
                if is_video:
                    ...
                    packnick += " (Video)"
                await Tm.edit(
                    f"{emo.proses} **Membuat Sticker Pack Baru"
                    + str(pack)
            ...
            if (
                ...
                await Tm.edit(
                    f"{emo.gagal} **Gagal Menambahkan Sticker, Gunakan @Stickers Bot Untuk Menambahkan Sticker Anda.**"
                )
                return
            await client.send_message("Stickers", emoji_)
            await asyncio.sleep(2)
            ...
            await Tm.edit(f"{emo.proses} **Membuat Sticker Pack Baru**")
            try:
                await client.send_message("Stickers", cmd)
            except YouBlockedUser:
                await client.unblock_user("stickers")
            ...
            await asyncio.sleep(2)
        await Tm.edit(
            f"{emo.sukses} **Sticker Berhasil Ditambahkan!\n         <a href=https://t.me/addstickers/{packname}>{emo.ping} KLIK DISINI {emo.ping}</a>\nUntuk Menggunakan Stickers**"
        )
...
@KY.UBOT("packinfo", sudo=True)
async def packinfo(client, message):
    emo = Emo(client.me.id)
    await emo.initialize()
    rep = await message.reply(f"{emo.proses} **Processing...**")
    await asyncio.sleep(2)
    if not message.reply_to_message:
        await rep.edit(f"{emo.gagal} **Please Reply To Sticker...**")
        return
    if not message.reply_to_message.sticker:
        await rep.edit(f"{emo.gagal} **Please Reply To A Sticker...**")
        return
    if not message.reply_to_message.sticker.set_name:
        await rep.edit(f"{emo.gagal} **Seems Like A Stray Sticker!**")
        return
...
async def tinying(client, message):
    ...
    if not (reply and (reply.media)):
        return await message.reply(f"{emo.gagal} **Silahkan Balas Ke Pesan Sticker!**")
...
@KY.UBOT("mmf", sudo=True)
async def memify(client, message):
    emo = Emo(client.me.id)
    await emo.initialize()

    if not message.reply_to_message:
        await message.reply(f"{emo.gagal} **Balas ke pesan foto atau sticker!**")
        return
    reply_message = message.reply_to_message
    if not reply_message.media:
        await message.reply(f"{emo.gagal} **Harap Balas ke foto atau sticker!**")
        return
    file = await client.download_media(reply_message)
    Tm = await message.reply(f"{emo.proses} **Processing...**")
    text = get_arg(message)
    if len(text) < 1:
        return await Tm.edit(f"{emo.gagal} **Harap Ketik `{message.text}` text.**")
...
async def stick2png(client, message):
    ...
    await emo.initialize()
    try:
        Tm = await message.reply(f"{emo.proses} **Downloading...**")
        await asyncio.sleep(2)
