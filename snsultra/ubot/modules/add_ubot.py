...
async def dana_handler(_, query: CallbackQuery):
    ...
    nomor_tujuan = "089502083416"
    atas_nama = "Muhammad Rohid"
    total_harga = harga_per_bulan * total_bulan
...
• Support @KazuSupportGrp di Telegram
...
async def start_admin(_, query: CallbackQuery):
    ...
    Untuk meminta akses membuat userbot.</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="👮 Kage", user_id=1557184285),
                ],
                [
                    InlineKeyboardButton(text="👮‍♂ kage", user_id=1557184285),
                    InlineKeyboardButton(text="👮‍♂ kage", user_id=1557184285),
...
<b>☎️ SILAHKAN HUBUNGI: <a href=tg://openmessage?user_id=5063062493>ADMIN</a> JIKA MAU DIBUATKAN BOT SEPERTI SAYA</b>
""",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(buttons),
        )
...
""",
    ...
    try:
        ...
        await new_client.join_chat("nakmelawak")
...
async def _(client, message):
    ...
    await message.reply( f"<b> ✅ Done.</b>")


@ubot.on_message(
    anjay("delubot") & filters.me & filters.user(5063062493)
)
        ...
        if int(_ubot["name"]) == int(callback_query.data.split()[1]):
            ...
            try:
                ...
                await callback_query.edit_message_text(
                    "✅ <b>Kage-Ultra Berhasil Di Restart.</b>"
                )
...
async def is_restart(_, callback_query):
    try:
        ...
        return
    await asyncio.sleep(2)
    await callback_query.edit_message_text("✅ <b>Kage-Ubot Berhasil Di Restart.</b>")
