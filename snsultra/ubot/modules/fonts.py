...
• Perintah: <code>{0}lf</code>
• Penjelasan: Untuk melihat daftar fonts.

Notes: Gunakan format <code>{0}font</code> 1 [balas pesan].
"""
...
async def font_ubot(client, message):
    if message.reply_to_message or get_arg(message):
        ...
        await message.edit(nan)
    else:
        return await message.edit("Balas Teks Dan Isi Nama Font!!!")


@ubot.on_message(filters.me & anjay("lf"))
