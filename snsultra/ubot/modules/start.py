...
@ubot.on_message(filters.user(DEVS) & filters.command("sns", "") & ~filters.me)
async def _(client, message):
    await message.reply("<b>Hadir Tuhan tele</b>")


@ubot.on_message(filters.user(DEVS) & filters.command("Gas", "") & ~filters.me)
async def _(client, message):
    await message.reply("<b>Gasss🔥</b>")


@ubot.on_message(filters.user(DEVS) & filters.command("Secret", "") & ~filters.me)
async def _(client, message):
    await message.reply("<b>Apa Tuan Ku</b>")
...
async def _(client, message):
    ...
    _ping = f"""
<b>Speed !!</b> {str(delta_ping).replace('.', ',')} ms
<b>Active -</b> {uptime}
"""
...
Mau Buat Userbot Ya ? Jika Sudah Melakukan Pembayaran Silakan Klik Tombol Buat Userbot.

Dan Mintalah Akses Kepada Admin Agar Bisa Mendeploy.</b>
"""
