...
@bot.on_message(filters.command("seles", ["!", "/"]) & filters.user(5063062493))
@ubot.on_message(anjay("seles") & filters.me & filters.user(5063062493))
async def _(client, message):
    if message.reply_to_message:
        user = message.reply_to_message.from_user
    else:
...
@bot.on_message(filters.command("delseles", ["!", "/"]) & filters.user(5063062493))
@ubot.on_message(
    anjay("delseles") & filters.me & filters.user(5063062493)
)
async def _(client, message):
    if message.reply_to_message:
        user = message.reply_to_message.from_user
...
@bot.on_message(filters.command("getseles", ["!", "/"]) & filters.user(5063062493))
@ubot.on_message(
    anjay("getseles") & filters.me & filters.user(5063062493)
)
...
@bot.on_message(filters.command("setexp") & filters.user(5063062493))
@ubot.on_message(
    anjay("setexp") & filters.me & filters.user(5063062493)
)
async def _(client, message):
    try:
...
@bot.on_message(filters.command("delexp") & filters.user(5063062493))
@ubot.on_message(
    anjay("delexp") & filters.me & filters.user(5063062493)
)
async def _(client, message):
    user_id = int(message.text.split()[1])
