...
DEFAULT_TEXT = """
<code>Saya adalah Kage Bot yang menjaga Room Chat Ini . Jangan Spam Atau Anda Akan Diblokir Otomatis.</code>
"""
...
@ubot.on_message(anjay("antipm") & filters.me)
@check_access
...
@ubot.on_message(anjay("ok") & filters.me)
@check_access
...
@ubot.on_message(anjay("no") & filters.me)
@check_access
