...
__HELP__ = f"""
 Document for Pinterest

• Command: <code>{cmd[0]}pinter</code> [link]
• Function: Untuk mengunduh media dari pinterest.
"""


@ubot.on_message(filters.me & filters.command("pinter", cmd))
