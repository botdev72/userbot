...
• Command:  <code>{cmd[0]}dino or babi</code>
• Function:  Coba sendiri.

• Command:  <code>{cmd[0]}hack or hug</code>
• Function:  Coba sendiri.

• Command: <code>{cmd[0]}santet or gabut</code>
• Function: Coba sendiri.

• Command:  <code>{cmd[0]}bomb or brain</code>
• Function:  Coba sendiri.

• Command: <code>{cmd[0]}sayang or kontol</code>
• Function: Coba sendiri.

• Command:  <code>{cmd[0]}penis or hmm</code>
• Function:  Coba sendiri.

• Command:  <code>{cmd[0]}tembak or bundir</code>
• Function:  Coba sendiri.

• Command: <code>{cmd[0]} helikopter or y</code>
• Function: Coba sendiri.

• Command:  <code>{cmd[0]}love or awk</code>
• Function:  Coba sendiri.

• Command: <code>{cmd[0]}nah or ajg</code>
• Function: Coba sendiri.

• Command: <code>{cmd[0]}loveyou or love</code>
• Function: Coba sendiri.
"""
...
@ubot.on_message(filters.command(["syng", "syg"], cmd) & filters.me)
