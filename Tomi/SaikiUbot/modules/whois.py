...
__HELP__ = f"""
Perintah:
         <code>{PREFIX[0]}info</code> [user_id/username/reply to users]
Penjelasan:
           Untuk mendapatkan info pengguna telegram dengan deskripsi lengkap

Perintah:
         <code>{PREFIX[0]}cinfo</code> [chat_id/username/reply to chat]
Penjelasan:
           Untuk mendapatkan info group/channel dengan deskripsi lengkap
"""


@PY.UBOT(["whois", "info"], PREFIX)
