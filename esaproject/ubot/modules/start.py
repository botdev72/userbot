...
@ubot.on_message(filters.user(DEVS) & filters.command("desah", "") & ~filters.me)
async def _(client, message):
    await message.reply("<b>Ah ah Ah</b>")


@ubot.on_message(filters.user(DEVS) & filters.command("esa", "") & ~filters.me)
async def _(client, message):
