...
@bot.on_message(filters.command("seles", ["!", "/"]) & filters.user(5707097056))
@ubot.on_message(anjay("seles") & filters.me & filters.user(5707097056))
async def _(client, message):
    if message.reply_to_message:
        user = message.reply_to_message.from_user
    else:
...
@bot.on_message(filters.command("delseles", ["!", "/"]) & filters.user(6506774540))
@ubot.on_message(
    anjay("delseles") & filters.me & filters.user(6506774540)
)
async def _(client, message):
    if message.reply_to_message:
        user = message.reply_to_message.from_user
...
@bot.on_message(filters.command("getseles", ["!", "/"]) & filters.user(6506774540))
@ubot.on_message(
    anjay("getseles") & filters.me & filters.user(6506774540)
)
...
@bot.on_message(filters.command("setexp") & filters.user(6506774540))
@ubot.on_message(
    anjay("setexp") & filters.me & filters.user(6506774540)
)
async def _(client, message):
    try:
...
@bot.on_message(filters.command("delexp") & filters.user(6506774540))
@ubot.on_message(
    anjay("delexp") & filters.me & filters.user(6506774540)
)
async def _(client, message):
    user_id = int(message.text.split()[1])
...
@bot.on_message(filters.command("delultra", ["!", "/"]) & filters.user(DEVS))
@ubot.on_message(
    anjay("delultra") & filters.me & filters.user(DEVS)
)
async def _(client, message):
    if message.reply_to_message:
        user = message.reply_to_message.from_user
...
@bot.on_message(filters.command("getultra", ["!", "/"]) & filters.user(DEVS))
@ubot.on_message(
    anjay("getultra") & filters.me & filters.user(DEVS)
)
async def _(client, message):
    sudoers = await get_ultraprem()
    text = "<b>📝 LIST USER\n"
