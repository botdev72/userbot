...
from ubot import ubot, get_expired_date, DEVS, get_seles, get_time, Button, unpackInlineMessage, get_var, bot, start_time, get_supro, get_violet
    ...
    for my in ubot._ubot:
        if int(get_id[2]) == my.me.id:
            ...
            if my.me.id in DEVS:
                ...
                status2 = "<b>user</b>"
            if my.me.id in await get_violet():
                status = "<b>super violet</b>"
            elif my.me.id in await get_supro():
                status = "<b>super pro</b>"
            else:
                status = "<b>pro</b>"
