...
async def buat_lognya(client):
    bot.me.username
    logs = await client.create_supergroup("Seller-Keren Logs 🇮🇩")
    url = wget.download("https://telegra.ph//file/ee41bc32fe33584651faf.jpg")
    desnya = "Group Log untuk Seller-Keren.\n\nHARAP JANGAN KELUAR DARI GROUP INI.\n\nPowered By ~ @UputtSupport"
