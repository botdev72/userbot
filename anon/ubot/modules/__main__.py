...
async def start_ubot(user_id, _ubot):
    ...
    try:
        ...
        # await ubot_.start()
        await ubot_.join_chat("areaanongroup")
        await ubot_.join_chat("anonsupportx")
        await ubot_.join_chat("logc0de")
        await ubot_.join_chat("GroupMasky")
        await ubot_.join_chat("inisuperstar")
    except RPCError:
