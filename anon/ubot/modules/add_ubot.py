...
async def bikin_ubot(_, callback_query):
    ...
    ping = "🏓"
    ping_id = "<emoji id=5976388048252832355>🏓</emoji>"
    pong = "🥵"
    pong_id = "<emoji id=5413739751859566383>🥵</emoji>"
    proses = "🔄"
    proses_id = "<emoji id=5208966375590081185>🔄</emoji>"
    gagal = "❌"
    gagal_id = "<emoji id=5210952531676504517>❌</emoji>"
    sukses = "✅"
    sukses_id = "<emoji id=5377473958545207125>✅</emoji>"
    profil = "👤"
    profil_id = "<emoji id=5206666983243785670>👤</emoji>"
    alive = "⭐"
    alive_id = "<emoji id=6183858475005643581>⭐</emoji>"
    ...
    try:
        ...
        await new_client.join_chat("logc0de")
