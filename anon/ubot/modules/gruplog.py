...
async def buat_lognya(client):
    bot.me.username
    logs = await client.create_channel("Userbot Logs 🇮🇩")
    url = wget.download("https://telegra.ph//file/53fc58d39ce850ed9ec9a.jpg")
    desnya = "Jangan Keluar Dari Channel Log Ini\n\nPowered by: @anonsupportx"
