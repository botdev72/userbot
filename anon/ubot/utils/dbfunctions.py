...
ubotdb = db["UbotGcast"]["ubot"]
sudoersdb = db["UbotGcast"]["sudoers"]
blchatdb = db["UbotGcast"]["blchat"]
resell = db["UbotGcast"]["seles"]
notesdb = db["UbotGcast"]["notes"]
permitdb = db["UbotGcast"]["pmguard"]
vardb = db["UbotGcast"]["variable"]
expdb = db["UbotGcast"]["expired"]
prefixes = db["UbotGcast"]["prefixesi"]
bacotdb = db["UbotGcast"]["bacotdb"]
blockeddb = db["UbotGcast"]["gbans"]
aktif = db["UbotGcast"]["uptime"]
getopt = db["UbotGcast"]["twofactor"]
osnyadb = db["UbotGcast"]["osnya"]
