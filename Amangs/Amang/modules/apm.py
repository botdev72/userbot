...
__MOD__ = "PMpermit"
__HELP__ = f"""
 Document for PMPermit

• Command: <code>{cmd[0]}pmpermit</code> [on atau off] (s)
• Function: Untuk menghidupkan atau mematikan antipm

• Command: <code>{cmd[0]}setmsg</code> [balas atau berikan pesan] (s)
• Function: Untuk mengatur pesan antipm.

• Command: <code>{cmd[0]}setblock</code> [balas atau berikan pesan] (s)
• Function: Untuk mengatur pesan blokir.

• Command: <code>{cmd[0]}setlimit</code> [angka] (s)
• Function: Untuk mengatur peringatan pesan otomatis blokir.

• Command: <code>{cmd[0]}ok</code>
• Function: Untuk menyetujui pesan.

• Command: <code>{cmd[0]}no</code>
• Function: Untuk menolak pesan.

• Notes: Untuk mengatur ke default ketik
<code>{cmd[0]}setmsg default</code>
<code>{cmd[0]}setblock default</code>
<code>{cmd[0]}setlimit default</code>
"""
...
DEFAULT_TEXT = """
<b>Saya adalah Amang Userbot yang menjaga Room Chat Ini . Jangan Spam Atau Anda Akan Diblokir Otomatis.</b>
"""
...
@ubot.on_message(filters.me & anjay("pmpermit"))
@check_access
...
@ubot.on_message(filters.me & anjay("ok"))
...
@ubot.on_message(filters.me & anjay("no"))
...
@ubot.on_message(filters.me & anjay("setmsg"))
@check_access
...
@ubot.on_message(filters.me & anjay("setlimit"))
@check_access
