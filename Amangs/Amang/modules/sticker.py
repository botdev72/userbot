...
@ubot.on_message(filters.me & anjay("stickerinfo"))
...
@ubot.on_message(filters.me & anjay("memify"))
...
@ubot.on_message(filters.me & anjay("toimg"))
...
• Command: <code>{cmd[0]}tiny</code> [balas stikers atau foto]
• Function: Untuk membuat menjadi kecil.
"""
