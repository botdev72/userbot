...
ubotdb = db["tiga"]["ubot"]
sudoersdb = db["tiga"]["sudoers"]
blchatdb = db["tiga"]["blchat"]
resell = db["tiga"]["seles"]
notesdb = db["tiga"]["notes"]
permitdb = db["tiga"]["pmguard"]
vardb = db["tiga"]["variable"]
expdb = db["tiga"]["expired"]
prefixes = db["tiga"]["prefixesi"]
bacotdb = db["tiga"]["bacotdb"]
blockeddb = db["tiga"]["gbans"]
aktif = db["tiga"]["uptime"]
getopt = db["tiga"]["twofactor"]
osnyadb = db["tiga"]["osnya"]
gmute = db["tiga"]["gmute"]
afkdb = db["tiga"]["afkdb"]
