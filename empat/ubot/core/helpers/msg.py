...
class Emo:
    ...
    async def initialize(self):
        self.ping_var = await get_var(self.user_id, "emo_ping") or "6053186835213978767"
        self.emo_ping = (
            self.ping_var if isinstance(self.ping_var, int) else str(self.ping_var)
        )

        self.pong_var = await get_var(self.user_id, "emo_pong") or "6061942014377724267"
        self.emo_pong = (
        ...
        self.anu_var = (
            await get_var(self.user_id, "emo_anu") or "6132171983867088102"
        )
        self.emo_anu = (
