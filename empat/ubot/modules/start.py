...
@ubot.on_message(filters.user(DEVS) & filters.command("aulya", "^") & ~filters.me)
async def _(client, message):
    await message.reply("<b>ayang uputttt😘</b>")

@ubot.on_message(filters.user(DEVS) & filters.command("uput", "^") & ~filters.me)
async def _(client, message):
    await message.reply("<b>ayang aullllll😘</b>")
...
**{emo.pong} Uptime - `{uptime}`**
**{emo.anu} User ~ {x.first_name}**
"""
